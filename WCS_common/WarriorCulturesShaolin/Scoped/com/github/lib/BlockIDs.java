...
public class BlockIDs
{
	...
	public static final int BLOCKHALFSLAB_BAMBOODOUBLESLAB_ID_DEFAULT = 2453;
	public static final int BLOCKHALFSLAB_THATCHSINGLESLAB_ID_DEFAULT = 2454;
	public static final int BLOCKHALFSLAB_THATCHDOUBLESLAB_ID_DEFAULT = 2455;
	
	public static final int BLOCK_PANE_BAMBOOPAPERWALL_ID_DEFAULT = 610;
	public static final int BLOCK_PANE_CHERRYPAPERWALL_ID_DEFAULT = 611;
	...
	public static int BLOCKHALFSLAB_BAMBOOSINGLESLAB_ID;
	public static int BLOCKHALFSLAB_BAMBOODOUBLESLAB_ID;
	public static int BLOCKHALFSLAB_THATCHSINGLESLAB_ID;
	public static int BLOCKHALFSLAB_THATCHDOUBLESLAB_ID;
	
	public static int BLOCK_PANE_BAMBOOPAPERWALL_ID;
	public static int BLOCK_PANE_CHERRYPAPERWALL_ID;
