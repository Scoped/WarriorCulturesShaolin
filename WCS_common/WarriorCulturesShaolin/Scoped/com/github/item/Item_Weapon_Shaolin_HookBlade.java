...
public class Item_Weapon_Shaolin_HookBlade extends Super_Item_Sword
{
	
	public Item_Weapon_Shaolin_HookBlade(int par1, EnumToolMaterial enumToolMaterial)
	{
		super(par1, enumToolMaterial);
		this.setUnlocalizedName(Strings.ITEM_SHAOLIN_HOOK_NAME);
	}
