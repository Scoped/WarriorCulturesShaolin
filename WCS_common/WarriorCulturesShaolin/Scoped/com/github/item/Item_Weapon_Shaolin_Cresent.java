...
public class Item_Weapon_Shaolin_Cresent extends Super_Item_Sword
{
	/** List of blade types. */
    public static final String[] types = new String[] {"", "WaxWood"};
    public static final String[] field_94595_b = new String[] {"", "WaxWood"};
    public static final String weaponName = "Cresent";
    @SideOnly(Side.CLIENT)
    private Icon[] field_94594_d;
	
	 public Item_Weapon_Shaolin_Cresent(int par1, EnumToolMaterial par2EnumToolMaterial)
	 {
