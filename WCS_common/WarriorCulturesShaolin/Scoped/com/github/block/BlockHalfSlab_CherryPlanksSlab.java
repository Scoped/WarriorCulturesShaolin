...
public class BlockHalfSlab_CherryPlanksSlab extends BlockHalfSlab
{
    ...
    private String iconTopString = "CherryWoodPlanks";
    private String iconSideString = "CherryWoodPlanks";
    private String iconSide2String = "CherryWoodPlanks";
	...
	public BlockHalfSlab_CherryPlanksSlab(int par1, boolean par2, Material par3Material)
	{
    ...
    {
        return this.blockID == ModBlocks.CherryPlanksDoubleSlab.blockID ? ModBlocks.CherryPlanksSingleSlab.blockID : ModBlocks.CherryPlanksSingleSlab.blockID;
    }
    
	public int idDropped(int par1, Random par2Random, int par3)
	{
		return ModBlocks.CherryPlanksSingleSlab.blockID;
	}
