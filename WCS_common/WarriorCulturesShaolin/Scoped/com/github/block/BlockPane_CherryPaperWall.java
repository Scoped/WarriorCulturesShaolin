...
public class BlockPane_CherryPaperWall extends Super_Pane
{

	protected BlockPane_CherryPaperWall(int par1, String texture, String topTexture, Material material, boolean par5)
	{
		super(par1, texture, topTexture, material, par5); // NOTE: Only string topTexture is called. String texture is ignored.
		this.sideTextureIndex = topTexture;
		this.setUnlocalizedName(Strings.BLOCK_PANE_CHERRYPAPERWALL_NAME);
	}
    ...
    {
        return Block.opaqueCubeLookup[par1] || par1 == this.blockID || par1 == ModBlocks.BambooPaperWall.blockID;
    }
